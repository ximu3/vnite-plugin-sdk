import type { IConfigDB, IGameDB, IPluginDB } from './database'
import type { IEventBus } from './event'
import type { IIpcManager } from './ipc'
import type { IScraperManager } from './scraper'
